...
### 第９条（保証の否認）
<ol>
  <li>本サービスは、現状有姿の状態にて提供されるものとします。当事務局は、以下の事項について、ユーザーに対する保証等を一切しないものとします。<ol>
    ...
    <li type="a">本サービスに係る情報等がすべての端末等において正常に表示されること</li></ol></li>
</ol>
...
<ol>
  ...
  <li>前項の第三者には以下の者を含むものとしますが、この限りではありません。<ol>
